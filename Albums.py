...
def fillAlbumReport(count):
    ...
    for i in range(columsalbumsreport):
        ...
        genrepara = Paragraph(albums[i].genre, genreStyle)
        ...
        albumreps[0].append_Table(i, titlegenretable)
        artistpara = Paragraph(albums[i].artist, artistStyle)
        yearpara = Paragraph(albums[i].year, yearStyle)
        ...
        albumreps[0].append_Table(i, artistyeartable)
    print(len(albumreps))
